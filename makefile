...
LDFLAGS+=-L. -g
#^|
EXAMPLESOBJS=  checkhair.o cuthair.o reception.o register.o queue.o main.o generat.o cpu.o transduc.o distri.o com.o linpack.o debug.o trafico.o
#W
...
#^|
checkhair.o: /cygdrive/C/eclipse/workspace/zzbarbershop/checkhair.cpp
	${CPP} -c ${LDFLAGS} ${INCLUDES_CPP} ${DEFINES_CPP} ${DEBUGFLAGS} ${CPPFLAGS} $< 
cuthair.o: /cygdrive/C/eclipse/workspace/zzbarbershop/cuthair.cpp
	${CPP} -c ${LDFLAGS} ${INCLUDES_CPP} ${DEFINES_CPP} ${DEBUGFLAGS} ${CPPFLAGS} $< 
reception.o: /cygdrive/C/eclipse/workspace/zzbarbershop/reception.cpp
	${CPP} -c ${LDFLAGS} ${INCLUDES_CPP} ${DEFINES_CPP} ${DEBUGFLAGS} ${CPPFLAGS} $< 
register.o: /cygdrive/C/eclipse/workspace/zzbarbershop/register.cpp
	${CPP} -c ${LDFLAGS} ${INCLUDES_CPP} ${DEFINES_CPP} ${DEBUGFLAGS} ${CPPFLAGS} $< 
#
...
#^|
checkhair.o: /cygdrive/C/eclipse/workspace/zzbarbershop/checkhair.cpp \
 /cygdrive/C/eclipse/workspace/zzbarbershop/checkhair.h \
...
cuthair.o: /cygdrive/C/eclipse/workspace/zzbarbershop/cuthair.cpp \
 /cygdrive/C/eclipse/workspace/zzbarbershop/cuthair.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/atomic.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/model.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/port.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/modelid.h \
 ...
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/ltranadm.h
reception.o: /cygdrive/C/eclipse/workspace/zzbarbershop/reception.cpp \
 /cygdrive/C/eclipse/workspace/zzbarbershop/reception.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/atomic.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/model.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/port.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/modelid.h \
